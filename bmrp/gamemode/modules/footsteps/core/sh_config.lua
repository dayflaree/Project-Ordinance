...
ax.config:Add("footstepReverbEnable", ax.type.bool, true, {category = "audio", subCategory = "footsteps", description = "Enable reverb layering for footsteps."})
ax.config:Add("footstepReverbVolume", ax.type.number, 0.25, {min = 0, max = 1, decimals = 2, category = "audio", subCategory = "footsteps", description = "Volume for reverb layering."})
ax.config:Add("footstepReverbDelay", ax.type.number, 0.0, {min = 0, max = 2, decimals = 2, category = "audio", subCategory = "footsteps", description = "Delay in seconds before reverb plays."})
